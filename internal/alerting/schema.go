...
func detectionProperties() []PropertySchema {
	return []PropertySchema{
		...
		{Name: PropertyNoveltyDaysActive, Label: "Novelty Days Active", Type: "number", Operators: numericOperators},
		{Name: PropertyNoveltyReason, Label: "Novelty Reason", Type: "string", Operators: stringOperators},
