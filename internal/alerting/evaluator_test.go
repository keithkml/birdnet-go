...
func TestEvaluateConditions_StringOperators(t *testing.T) {
	tests := []struct {
		...
		{"in match", OperatorIn, "scientific_name", "Turdus migratorius, Sitta carolinensis", "Sitta carolinensis", true},
		{"in no match", OperatorIn, "scientific_name", "Turdus migratorius, Sitta carolinensis", "Setophaga castanea", false},
		{"not_in match", OperatorNotIn, "scientific_name", "Turdus migratorius, Sitta carolinensis", "Setophaga castanea", true},
		{"not_in no match", OperatorNotIn, "scientific_name", "Turdus migratorius, Sitta carolinensis", "Sitta carolinensis", false},
